...
class TestPDFMergerFileNotFoundError:
    """Test cases for PDFMergerFileNotFoundError."""

    def test_file_not_found_error_with_path(self):
        """Test creating PDFMergerFileNotFoundError with path."""
        path = Path("/nonexistent/file.txt")
        error = PDFMergerFileNotFoundError(path)
    ...
    def test_file_not_found_error_with_custom_type(self):
        """Test creating PDFMergerFileNotFoundError with custom file type."""
        path = Path("/nonexistent/folder")
        error = PDFMergerFileNotFoundError(path, file_type="Source folder")
    ...
    def test_file_not_found_error_with_string_path(self):
        """Test creating PDFMergerFileNotFoundError with string path."""
        path_str = "/nonexistent/file.txt"
        error = PDFMergerFileNotFoundError(path_str)
