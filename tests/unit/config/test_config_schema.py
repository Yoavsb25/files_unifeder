...
from pdf_merger.config.config_schema import (
    validate_input_file,
    validate_source_dir,
    validate_output_dir,
    validate_column,
...
class TestConfigSchema:
    """Test cases for config_schema validation functions."""
    ...
    def test_validate_input_file_none(self):
        ...
        result = validate_input_file(None)
    ...
    def test_validate_input_file_not_exists(self):
        ...
        with pytest.raises(ValueError, match="does not exist"):
            validate_input_file("/nonexistent/file.csv")
    ...
    def test_validate_source_dir_valid(self, tmp_path):
        ...
        result = validate_source_dir(str(test_dir))
    ...
    def test_validate_source_dir_not_exists(self):
        ...
        with pytest.raises(ValueError, match="does not exist"):
            validate_source_dir("/nonexistent/dir")
    ...
    def test_validate_source_dir_not_dir(self, tmp_path):
        ...
        with pytest.raises(ValueError, match="is not a directory"):
            validate_source_dir(str(test_file))
    ...
    def test_validate_output_dir_valid_existing(self, tmp_path):
        ...
        result = validate_output_dir(str(test_dir))
