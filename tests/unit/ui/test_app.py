...
class TestPDFMergerApp:
    ...
    def test_app_initialization(self, mock_license_manager):
        ...
        mock_manager.get_license_info.return_value = {"company": "Test", "expires": "2027-12-31"}
    ...
    def test_check_license_valid(self, mock_update_license):
        ...
        mock_update_license.assert_called_once_with(
            app.license_manager, app.license_frame.license_label
        )
    ...
    def test_load_config_into_ui_all_fields(
        self, mock_validate_folder, mock_validate_file, tmp_path
    ):
        ...
        mock_config = AppConfig(
            input_file=str(input_file), pdf_dir=str(source_dir), output_dir=str(output_dir)
        )
    ...
    def test_load_config_into_ui_invalid_input_file(self, tmp_path):
        ...
        mock_config = AppConfig(input_file="/nonexistent/file.csv")
    ...
    def test_load_config_into_ui_invalid_source_dir(self):
        ...
        mock_config = AppConfig(pdf_dir="/nonexistent/dir")
    ...
    def test_load_config_into_ui_output_dir_creation(self, tmp_path):
        ...
        mock_config = AppConfig(output_dir=str(output_dir))
    ...
    def test_show_detailed_report_opens_dialog_with_report(
        self, mock_format_detailed, mock_toplevel
    ):
